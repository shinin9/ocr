...
if __name__ == '__main__':
    ...
    parser.add_argument('--valid_data', default='data_lmdb/validation', help='path to validation dataset')
    parser.add_argument('--manualSeed', type=int, default=1111, help='for random seed setting')
    parser.add_argument('--workers', type=int, help='number of data loading workers', default=0)
    parser.add_argument('--batch_size', type=int, default=50, help='input batch size')
    parser.add_argument('--num_iter', type=int, default=800, help='number of iterations to train for')
    ...
    parser.add_argument('--Prediction', default='CTC', type=str, help='Prediction stage. CTC|Attn')
